  ...
  const categories: Category[] = [
    {
      ...
      disabledHoverColor: "hover:bg-indigo-400",
      enabledHoverColor: "hover:bg-indigo-300",
    ...
    },
    {
      ...
      disabledHoverColor: "hover:bg-cyan-400",
      enabledHoverColor: "hover:bg-cyan-300",
    ...
    },
    {
      ...
      disabledHoverColor: "hover:bg-amber-400",
      enabledHoverColor: "hover:bg-amber-300",
    ...
    },
    {
      ...
      disabledHoverColor: "hover:bg-emerald-400",
      enabledHoverColor: "hover:bg-emerald-300",
    ...
    },
    {
      ...
      disabledHoverColor: "hover:bg-fuchsia-400",
      enabledHoverColor: "hover:bg-fuchsia-300",
